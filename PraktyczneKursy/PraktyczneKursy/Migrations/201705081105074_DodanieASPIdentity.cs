namespace PraktyczneKursy.Migrations
{
    ...
    public partial class DodanieASPIdentity : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Zamowienie", "ApplicationUser_Id", c => c.String(maxLength: 128));
            CreateIndex("dbo.Zamowienie", "ApplicationUser_Id");
            AddForeignKey("dbo.Zamowienie", "ApplicationUser_Id", "dbo.AspNetUsers", "Id");
        }
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.Zamowienie", "ApplicationUser_Id");
